...
<ResponseField name="TRANSACTION" type="object">
  ...
  <Expandable title="TRANSACTION object">
    ...
    <ResponseField name="gasFeeCap" type="string">
        maxFeePerGas,Maximum fee, in Wei, the sender is willing to pay per gas above the base fee
    </ResponseField>

    <ResponseField name="gasTipCap" type="string">
        maxPriorityFeePerGas,Maximum total fee (base fee + priority fee), in Wei, the sender is willing to pay per gas
    </ResponseField>
