...
### compatibility
Axiom currently supports subscription methods such as newHeads, logs, and newPendingTransactions, making it compatible with most Ethereum subscription mechanisms. However, it does not support the syncing subscription. If you require information about the synchronization status of a node, you can directly query this information through the HTTP endpoint eth_syncing instead.
