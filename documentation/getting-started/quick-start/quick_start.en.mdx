...
![transfer token](../../images/getting-started/quick-start/transfer-token.png)
...
AxiomLedger provides an official blockchain explorers - [AXMScan](). During the process of interacting with the AxiomLedger blockchain, you can view the block or transaction information of the Testnet at any time. You can learn more about how to use AXMScan [here](../../getting-started/resources/resources.en#axmscan).