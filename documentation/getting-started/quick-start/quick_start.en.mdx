---
title: "Quick Start with AxiomLedger"
---

This guide will introduce you how to quickly access and use the AxiomLedger blockchain. You can easily initiate transactions, mint tokens, and build Dapps on the AxiomLedger blockchain. You can also view  Block and transaction information through AxiomLedger’s explorers, I believe this will be helpful for your subsequent development on AxiomLedger.
...
AxiomLedger provides an official blockchain explorers, the address of the Testnet explorers is `explorer.aries.axiomesh.io`. During the process of interacting with the AxiomLedger blockchain, you can view the block or transaction information of the Testnet at any time.