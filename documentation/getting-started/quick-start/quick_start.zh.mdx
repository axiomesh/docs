...
![转账token](../../images/getting-started/quick-start/transfer-token.png)

转账完成后，可以在MetaMask上切换到新账户，查看其余额变化
<img src="../../images/getting-started/quick-start/check-balance.png" width="300" />

## 体验AxiomLedger区块链浏览器
AxiomLedger提供了官方的区块链浏览器。您在与AxiomLedger交互的过程中，可以随时查看测试网的区块/交易信息。 您可以在[此处](../../getting-started/resources/resources.zh#axmscan)了解更多关于AXMScan的使用方法。