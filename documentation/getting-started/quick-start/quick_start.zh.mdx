...
这份指南将向您介绍如何快速接入和使用 AxiomLedger 区块链，您可以十分方便地在 AxiomLedger 区块链上发起交易、铸造代币，发布 Dapps，也可以通过 AxiomLedger 的区块链浏览器查看区块和交易的信息，相信这将对您后续在 AxiomLedger 上进行开发有一定的帮助作用。
