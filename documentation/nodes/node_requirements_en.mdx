...
## Why These Hardware Requirements
...
- 9991: JSON RPC http port for providing services externally. This port is optional to open.

Close the following ports:

- 53121/40011: Node metrics exposure ports. Close to prevent unauthorized node metrics inspection.