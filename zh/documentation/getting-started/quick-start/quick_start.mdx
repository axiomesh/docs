...
如果您是第一次使用MetaMask，请点击[此处](https://metamask.io/download/)安装插件。如果您是第一次连接 AxiomLedger，您需要将RPC 地址、链 ID、代币符号等信息新增到网络列表。
- 测试网的 RPC 地址：`https://rpc1.aries.axiomesh.io`
- 链ID：`23411`
- 代币符号： `AXM`

连接到 AxiomLedger 后，一般来说您的账户余额是 `0` AXM，此时您可以访问 AxiomLedger [测试网水龙头](https://faucet.aries.axiomesh.io)，在页面上填入您的账户地址来获取`0.5`AXM。
