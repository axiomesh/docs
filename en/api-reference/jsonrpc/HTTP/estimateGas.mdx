...
<ParamField body="params" type="array">
  ...
  <Expandable title="TRANSACTION CALL ARGS">
     ...
     <ParamField body="maxFeePerGas" type="string">
        Maximum fee, in Mol, the sender is willing to pay per gas above the base fee
     </ParamField>

     <ParamField body="maxPriorityFeePerGas" type="string">
        Maximum total fee (base fee + priority fee), in Mol, the sender is willing to pay per gas
     </ParamField>
