...
This section will introduce the authenticated data structure and KV storage engine in ledger components, as well as the verification process of SPV nodes.
...
2. The client requests the Merkle proof from full nodes.
...
![SPV steps in AxiomLedger](/en/images/system-design/spv1.png)
