...
![consensus architecture diagram](/en/images/system-design/consensus-architecture-en.png)
...
![node state machine](/en/images/system-design/node-state-machine-en.png)
...
![epoch change process](/en/images/system-design/epoch-change-en.png)
