...
## AXMScan
The [AXMScan-Testnet](https://explorer.aries.axiomesh.io) lets you delve into the activity on the Axiomesh TestNet in great detail, seeing transactions, blocks, wallets, tokens, smart contracts and Statistics. 
