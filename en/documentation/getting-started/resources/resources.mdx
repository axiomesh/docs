...
## AXMScan
The [AXMScan](https://explorer.aries.axiomesh.io) lets you dive into the activity on the AxiomLedger testnet in great detail, seeing transactions, blocks, wallets, tokens, smart contracts and statistics. 
