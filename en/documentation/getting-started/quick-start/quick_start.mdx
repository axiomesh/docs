...
After successfully connecting to the AxiomLedger, your account balance will generally be `0` AXC. At this time, you can visit the AxiomLedger testnet [faucet](https://faucet.aries.axiomesh.io/) and enter your account address on the webpage to receive some AXMs.

**_Please note: Within a 24-hour period, each account can only obtain AXC once from the faucet._**
