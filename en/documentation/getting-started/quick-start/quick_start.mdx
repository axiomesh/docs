...
**The following steps will take the Taurus testnet as an example. If you want to try it on the mainnet or other testnets, you can view related resources on the [Resources](/en/documentation/getting-started/resources/resources) page.**
...
After successfully connecting to the AxiomLedger, your account balance will generally be `0` AXM. At this time, you can visit the AxiomLedger testnet [faucet](https://faucet.taurus.axiomesh.io/) and enter your account address on the webpage to receive some AXMs.
