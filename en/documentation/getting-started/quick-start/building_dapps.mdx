...
This guide will introduce how to set up development tools and develop Dapps on `AxiomLedger`, using the well-known decentralized exchange `Uniswap@V2` as an example.
...
AxiomLedger provides an official blockchain explorers, the address of the Testnet blockchain explorers is `https://scan.aries.axiomesh.io`. During the process of interacting with the AxiomLedger, you can view the block/transaction information of the Mainnet or Testnet at any time.
