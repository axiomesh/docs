...
`AXM` is the native coin of `AxiomLedger`. Users interact with `AxiomLedger` may need to pay in `AXM`.

In testnet, you can visit [faucet](https://faucet.aries.axiomesh.io) to get some test coin.

For more detailed information, you can visit [Native Coin](/en/documentation/economics/coin).
